...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="{{ asset('site3assets/assets/img/favicon.ico') }}" />
...
<body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
        <a class="navbar-brand js-scroll-trigger" href="{{ route('site3.about') }}">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav">
                <li class="nav-item"><a
                        ...
                        {{-- {{ request()->url == route('site3.about') ? 'active' : ''}} --}}
                        {{ request()->routeIs('site3.about') ? 'active' : '' }}
                        "href="{{ route('site3.about') }}">About</a>
                </li>
                <li class="nav-item"><a
                        class="nav-link js-scroll-trigger
                        {{-- {{ request()->url == route('site3.experience') ? 'active' : '' }} --}}
                        {{ request()->routeIs('site3.experience') ? 'active' : '' }}
                        "href="{{ route('site3.experience') }}">Experience</a>
                </li>
                <li class="nav-item"><a
                        class="nav-link js-scroll-trigger
                        {{-- {{ request()->url == route('site3.education') ? 'active' : '' }} --}}
                        {{ request()->routeIs('site3.education') ? 'active' : '' }}
                        "href="{{ route('site3.education') }}">Education</a>
                </li>
                <li class="nav-item"><a
                        class="nav-link js-scroll-trigger
                ...
                <li class="nav-item"><a
                        class="nav-link js-scroll-trigger
                        {{-- {{ request()->url == route('site3.interests') ? 'active' : '' }} --}}
